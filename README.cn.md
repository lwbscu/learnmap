...
- [2026/07] 🔥 LearnMap runtime v2 新增不遮字的方形笔记徽标、增强高亮、可直接重编辑已保存文字且列表仅作用于框选行的紧凑白色 B/I/U/列表/图片浮动笔记卡、图片上传与剪贴板粘贴、点击放大笔记图片、自定义标记/笔记颜色、兼容 v1 笔记包、等待 5 个子 Agent 结论、默认不设 runtime/正文/总 HTML 体积上限，并上线含可交互课件的双语统一 Demo Center。
